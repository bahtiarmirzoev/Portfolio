            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <motion.button
                  ...
                  className={`rounded-2xl border border-white/10 px-4 py-3 text-sm transition-colors ${
                    showOngoing ? 'bg-white text-black shadow-lg' : 'bg-black/40 text-white/70 hover:text-white'
                  }`}
                >
                  {t('ongoing')}
                </motion.button>
